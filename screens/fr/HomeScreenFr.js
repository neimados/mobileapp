...
function HomeScreenFr({ navigation }) {
			...
			<ImageBackground source={require('../../assets/bg_home.png')} style={styles.bg_image}>
				<View style={styles.container}>
					...
					<Pressable style={styles.button} onPress={() => navigation.navigate('cat1')}>
						<Text style={styles.bt_txt}>Chats</Text>
					</Pressable>
					...
					<Pressable style={styles.button} onPress={() => navigation.navigate('cat3')}>
						<Text style={styles.bt_txt}>Histoire</Text>
					</Pressable>
					...
					<Pressable style={styles.button} onPress={() => navigation.navigate('cat5')}>
						<Text style={styles.bt_txt}>Autres</Text>
					</Pressable>
					<Pressable style={styles.flags} onPress={() => navigation.navigate('home')}>
						<Image style={styles.flags_img} source={require('../../assets/en.png')}/>
					</Pressable>
				</View>
			</ImageBackground>
		</SafeAreaView>
